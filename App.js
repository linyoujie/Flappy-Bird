...
export const randomBeteern = (min, max) =>{
  return Math.floor(Math.random() * (max -min +1) + min);
  
}

export const generatePipes = () => {
  let topPipHeight = randomBeteern(100,(Constants.MAX_HEIGHT/2) -100);
  let bottomPipHeight = Constants.MAX_HEIGHT - topPipHeight - Constants.GAP_SIZE
 
  let sizes = [topPipHeight, bottomPipHeight]
